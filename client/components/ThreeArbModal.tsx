...
const ThreeArbModal = ({ props }: props) => {
  ...
  useEffect(() => {
    const arb = 1 / props.HomeOdds + 1 / props.DrawOdds + 1 / props.AwayOdds;
    //set arbProfit
    ...
    const drawArb = (stake * 1) / props.DrawOdds / arb;
    const drawProfit = drawArb * props.DrawOdds;
    setDrawStake({
      stake: Number(drawArb.toFixed(2)),
      profit: Number(drawProfit.toFixed(2)),
    });
          ...
          >
            ...
            >
              ...
              >
                ...
                <Typography variant="h6"> {props.Draw}</Typography>
              ...
              >
                ...
                <Typography variant="h6"> {drawStake.stake}</Typography>
              ...
              >
                ...
                <Typography variant="h6">{drawStake.profit} </Typography>
